...
function tickInner(state: GameState, players: Item<Player>[], homeTeam: Team, awayTeam: Team, day: number) {
...
function tickOuter(setGameState: Dispatch<SetStateAction<GameState>>, players: Item<Player>[], homeTeam: Team, awayTeam: Team, day: number): TimeoutObject {
    ...
    setGameState((prevState) => {
        ...
        const delay = tickInner(state, players, homeTeam, awayTeam, day)
        if (delay !== null) {
            timeoutInfo.timeout = setTimeout(() => tickOuter(setGameState, players, homeTeam, awayTeam, day), 5000)
        }
...
function Game({teams, players, day}: { teams: [Team, Team], players: Item<Player>[], day: number }) {
    ...
    useEffect(() => {
        ...
        const timeoutObject = tickOuter(setGameState, players, homeTeam, awayTeam, day)
        return () => {
            if (timeoutObject.timeout !== null) clearTimeout(timeoutObject.timeout)
        }
    }, [players, homeTeam, awayTeam, day])
                ...
                <div className="GameWidget-Header-Wrapper">
                    <div className="GameWidget-Header">
                        <div className="GameWidget-StatusBar">
                            <div className="GameWidget-Status GameWidget-Status--Live">Live - {gameState.inning}
                                {gameState.top ? "▲" : "▼"}
                            </div>
                            {/* TODO Weather */}
                ...
                <div className="Main-Body">
                    <div>
                        ...
                        <div>
                            ...
                            {games.map(gameTeams => <Game teams={gameTeams} players={players} day={state.day}
